...
gulp.task('compile-css', ['sass-globbing'], require('./tasks/gulp/compile-css')(gulp, plugins, showError));
gulp.task('compile-pattern-lab', ['install-pattern-lab'], require('./tasks/gulp/compile-pattern-lab')(gulp, plugins, showError));
...
gulp.task('minify-js', require('./tasks/gulp/minify-js')(gulp, plugins, showError));
gulp.task('optimize-images', require('./tasks/gulp/optimize-images')(gulp, plugins, showError));
...
gulp.task('watch', require('./tasks/gulp/watch')(gulp, plugins, runSequence));
